...
public class SameIdSameCompany extends TestBase {
    @Parameters("dataEnv")
    @Test
    public static void parseCsvForSameEmployeeIdSameCompany(String dataEnv) throws Exception {
        enterCsvFilePath(dataEnv,"SameEmployeeIdSameCompany","SameIdSameProjects11 - Sheet1.csv");
        Thread.sleep(1000);
    ...
    public static void companyInfoSN1(String dataEnv) throws Exception {
        ...
        TestUtils.assertSearchText("XPATH","//android.view.View[@index='10']","N2340.00");
        testInfo.get().info("Cost of Employee1");
        TestUtils.assertSearchText("XPATH","//android.view.View[@index='14']","N6050.00");
        testInfo.get().info("Total Cost for both Employees");
        TestUtils.assertSearchText("XPATH","//android.view.View[@index='16']","N8390.00");
        TestUtils.testTitle("Verify the  total cost for the company for the employees");
        AssertBase.assertCostForEmployee();
    }

    @Parameters("dataEnv")
    @Test
    public static void companyInfoSN2(String dataEnv) throws Exception {
        WebDriverWait wait = new WebDriverWait(getDriver(), 50);
        ...
        testInfo.get().info("Cost of Employee1");
        TestUtils.assertSearchText("XPATH","//android.view.View[@index='14']","N10880.00");
        testInfo.get().info("Total Cost for both Employees");
        TestUtils.assertSearchText("XPATH","//android.view.View[@index='16']","N11180.00");
        TestUtils.testTitle("Verify the  total cost for the company for the employees");
        AssertBase.assertCostForEmployee();
    }
}
